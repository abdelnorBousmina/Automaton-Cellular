...
{Implementation of a mathematical model simulating the evacuation of pedestrians in a room. It also generates diagrams representing some statistics on the progress of the evacuation.}
...
\chapter{Analyse du projet}
	...
	\input{files/competences.tex}
	
	\input{files/ameliorations_raf.tex}
